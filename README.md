...
#set GIT_SSL_NO_VERIFY=true   -> fix lỗi fatal: unable to access 'https://github.com/eriklehnsher/pracs.git/': error setting certificate file: E:\apps-data\Git\mingw64\etc\ssl\certs\ca-bunble.crt
